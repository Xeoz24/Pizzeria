...
public class Login {
    ...
    private static  ListaUsuario lista_usuarios = new ListaUsuario();
...
// Autenticacion num_telefonico
    ...
    public static int buscarUsuario(String metodo_ini) {
    ...
    public static Usuario obtenerUsuario(int indice) {
        return lista_usuarios.obtenerUsuario(indice);
    }
    public  static String getMensajeAdmin(){
